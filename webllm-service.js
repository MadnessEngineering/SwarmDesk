...
class WebLLMService {
    ...
    async initialize() {
        ...
        try {
            ...
            this.webLLMEngine = await CreateWebWorkerEngine({
    ...
    async loadModel(modelId = 'Llama-3.2-3B-Instruct-q4f32_1-MLC') {
        if (!this.initialized) {
